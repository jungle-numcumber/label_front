...
function SideBar(props) {
    ...
    if (commitInput.current.value !== '') {
      axios
        ...
        .then(response => {
          ...
          axios
            .get(`https://inkyuoh.shop/commits/users/${userIdx}/books/${props.currentBookInfo.pdfIdx}`)
            .then(response => {
  ...
  return (
    <>
      <div className={styles.sideBarContents} style={sideBarStatus === true ? {} : { display: 'none' }}>
        <div className={styles.bookInfo}>
          <div
            ...
            style={{
              backgroundImage: 'url(' + `${process.env.PUBLIC_URL + `${props.currentBookInfo.firstPageLink}`}`,
            }}
          ></div>
        ...
        <div className={styles.historyContainer}>
          ...
          <form
            ...
            className={styles.historyInputWrap}
          >
          ...
          <div className={styles.historyWrap}>
            <History
              ...
              setCommitIdx={props.setCommitIdx}
      ...
      <FontAwesomeIcon
        icon={sideBarStatus === true ? faAngleLeft : faAngleRight}
                  ...
                  <div className={styles.wrapForTooltipRollBack}>
                    ...
                    <FontAwesomeIcon
                      ...
                      onClick={() => {
                        if (
                          window.confirm(
                            '해당 기록으로 되돌아가시겠습니까?\n현재 작업 내용으로도 돌아오길 원하신다면 저장을 먼저 해주세요.',
                          ) === true
                        ) {
                          rollback(element);
                        }
