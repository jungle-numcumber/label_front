        ...
        <section className={styles.sectionTitle}>
          ...
          >
            ...
            <input
              ...
              placeholder="찾고 싶은 책 이름 또는 제목을 입력해보세요."
            ></input>
          </label>
        </section>
        {close === true ? (
...
const Book = props => {
  ...
  return (
    <div className={styles.bookContainer}>
      <div
        onClick={() => {
          navigate('/personalreading', { state: { pdfIdx: props.result.pdfIdx, recentlyReadPage: 1 } });
        }}
      ...
      <div
        onClick={() => {
          navigate('/personalreading', {
            state: { pdfIdx: props.result.pdfIdx, recentlyReadPage: props.result.recentlyReadPage },
          });
        }}
        className={styles.book}
        style={{
