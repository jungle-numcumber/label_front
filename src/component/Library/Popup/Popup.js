      ...
      <div className={styles.popBox}>
        ...
        <aside className={styles.aside}>
          ...
          <p className={styles.p}>
            ...
            <br />
            1. <b style={{ color: 'red' }}>PDF 파일</b>만 업로드가 가능합니다.
            <br />
            2. <b style={{ color: 'red' }}>제목 작성</b> 후 파일 선택을 눌러주세요.
            <br />→ 작성하지 않을 시 파일이 업로드 되지 않습니다!
          </p>
          <button className={styles.btn} onClick={clickUpload}>
            파일 업로드
          </button>
