...
function NavDefault() {
  ...
  function eraseCookie() {
    console.log('hello');
    axios
      .post('https://inkyuoh.shop/logout', {
  ...
  return (
    <header className={styles.headerRead}>
      <div>
        <img
          className={styles.logoRead}
          src={process.env.PUBLIC_URL + '/images/labelLogoWhite.png'}
          onClick={() => {
            navigate('/library');
          }}
        ></img>
    ...
    <header className={styles.headerRead}>
      ...
      <nav className={styles.navRead}>
        ...
        <img
          ...
          src={process.env.PUBLIC_URL + `/images/division1.png`}
        />
        <img
          className={styles.switch}
          onClick={() => {
          ...
          src={process.env.PUBLIC_URL + `/images/division2.png`}
        />
        <img
          className={styles.switch}
          onClick={() => {
          ...
          src={process.env.PUBLIC_URL + `/images/division3.png`}
        />
      </nav>
    </header>
  );
...
const UserImg = () => {
  ...
  return <UserInfo result={result} length={result.length}></UserInfo>;
};
